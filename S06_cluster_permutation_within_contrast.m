%% S06_cluster_permutation_pre_vs_post.m
%
...
%           <subjectID>_post_MMN_<contrast>.mat  > from S04_MMN_by_contrast_pre_post.m
...
outDir = 'C:\Github_scripts\ERP_differences_by_contrast';   % <-- change to your folder
