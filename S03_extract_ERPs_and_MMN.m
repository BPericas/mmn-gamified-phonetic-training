...
%
%  Input:   <subjectID>_GEDAIclean.set   (output of S02_run_GEDAI_artefact_removal.m)
...
figure; hold on;
plot(times_s, STD_fc, 'b', 'LineWidth', 2);
plot(times_s, DEV_fc, 'r', 'LineWidth', 2);
xline(0, 'k:'); yline(0, 'k:');
